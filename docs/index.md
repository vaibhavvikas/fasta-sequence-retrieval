...
5. Your output will be generated inside the output directory. Please test with small numbers of sequences first to make sure you're getting what is expected.

## Credits

This package was created with Cookiecutter and the `vaibhavvikas/cookiecutter-pypackage` project template.
